...
checked_data <- raw_data |>
  ...
  # 6. Country of interview shouldn't match nationality or journey start
  validate_country_of_interview() |>
  # 7. Implausible back-to-back interviews (gap < 10 minutes)
  validate_back_to_back(threshold_mins = 10) |>
  # 8. External logical checks (requires a checklist dataframe)
